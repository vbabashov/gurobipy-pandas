...
# MAGIC %md
# MAGIC \begin{equation}
# MAGIC \sum_{i \in I(k) \cap I(n) } u_{ikn}   <= \sum_{i \in I(k) } x_{ik}\quad \forall\; k \in K, n \in N(k)
# MAGIC \end{equation}
...
# MAGIC b
# MAGIC \begin{equation}
# MAGIC u_{ik'n} \le (1 - Extra_{ik})  \quad \forall\; i \in I, k,k' \in K\,, k' \ne k, n = T_k
# MAGIC \end{equation}
...
# MAGIC %md
# MAGIC \begin{equation}
# MAGIC \sum_{i \in I(k) \cap I_c \cap I(T_k) } (Extra_{ik} +  x_{ik}) = 1 \quad \forall\; k \in K, \;
# MAGIC \end{equation}
...
# MAGIC %md
# MAGIC \begin{equation}
# MAGIC \sum_{k \in K} (x_{ik} + Extra_{ik}) <= 1 \quad \forall\; i \in I(k) \cap I_c \cap I(T_k) , \;
# MAGIC \end{equation}

# COMMAND ----------

# MAGIC %md
# MAGIC #### 6. One consultant Per Each String

# COMMAND ----------

# MAGIC %md
# MAGIC \begin{equation}
# MAGIC \sum_{i \in I(s) \cap I_c} y_{is} >= 1 \quad \forall\; s \in S, \;
# MAGIC \end{equation}

# COMMAND ----------

# MAGIC %md
# MAGIC #### 7. String - Asset Count Relationship

# COMMAND ----------

# MAGIC %md
# MAGIC \begin{equation}
# MAGIC y_{is} <= \sum_{n \in N(k)} u_{ikn} \quad \forall\; i \in I(s), k \in K(s), s \in S
# MAGIC \end{equation}

# COMMAND ----------

# MAGIC %md
# MAGIC #### 8. Changeover - Asset Count Relationship
...
# MAGIC b
# MAGIC \begin{equation}
# MAGIC Extra_{ik} <= \sum_{n \in N(k)} u_{ikn} \quad \forall\; i \in I(k), k \in K
# MAGIC \end{equation}

# COMMAND ----------

# MAGIC %md
# MAGIC #### 9. String - Changeover Relationship

# COMMAND ----------

# MAGIC %md
# MAGIC \begin{equation}
# MAGIC y_{is} <=  (x_{ik} + Extra_{ik}) \quad \forall\; i \in I(s), k \in K(s), s \in S
# MAGIC \end{equation}
...
# MAGIC %md
# MAGIC #### 10. Auxilary Constraint: Total Additional Resources Needed

# COMMAND ----------

# MAGIC %md
# MAGIC \begin{equation}
# MAGIC \sum_{k}\sum_{n \in N(k)}  z_{kn} +  \sum_{i \in I(k)}\sum_{k} Extra_{ik}=  w
# MAGIC \end{equation}

# COMMAND ----------

# MAGIC %md
# MAGIC #### 11.Auxilary Constraint: Assignment indicator for distance 
...
# MAGIC %md
# MAGIC #### 12. Auxilary Constraint: Fairness/Total Workload
